...
try {
    ...
    $userRole = $user['Role']; 
    $inboxActive = ($userRole === 'TR') ? 'active' : '';

  /*Check User multiple role*/
   if (!$user || !in_array($user['Role'], ['TR', 'EN'])) {
       session_destroy();
       header("Location: ../login.php");
       exit();
   }
         ...
         <ul class="navbar-nav me-auto">
          <?php if ($userRole !== 'TR'): ?>
            <li class="nav-item" id="home-quote">
                <a class="nav-link text-white active" href="#" name="menu" menucode="branch">Branch</a>
            </li>
          <?php endif; ?>
          <?php if ($userRole !== 'EN'): ?>
            <li class="nav-item" id="home-quote">
                <a class="nav-link text-white <?php echo $inboxActive; ?>" href="#" name="menu" menucode="bank_accounts" >Bank Accounts</a> 
            </li>
          <?php endif; ?> 
             <li class="nav-item">
