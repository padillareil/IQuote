...
try {
  ...
  /*Check User multiple role*/
   if (!$user || !in_array($user['Role'], ['Coordinator'])) {
       session_destroy();
       header("Location: ../login.php");
       exit();
   }
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="main-menu">
          <ul class="navbar-nav me-auto">
            <li class="nav-item"><a class="nav-link text-white active" href="#" name="menu" menucode="home">Quotations</a></li>
            <li class="nav-item"><a class="nav-link text-white" href="#" name="menu" menucode="reactivatelogs">Reactivate Logs</a></li>
            <li class="nav-item"><a class="nav-link text-white" href="#" name="menu" menucode="expiry">Expiration Control</a></li>
            <li class="nav-item"><a class="nav-link text-white" href="#" name="menu" menucode="website">Website Control</a></li>
