<div class="container">
	<div class="card shadow-sm">
		<div class="card-header">
			<h4 class="card-title ml-2">Re-Acivated Quotations</h4>
...
<script>
	...
	function loadReactivate(page = 1) {
	  if (isLoading) return;
	  ...
	  $.post("dirs/reactivatelogs/actions/get_reactivatelogs.php", {
	...
	$("#btn-preview").on("click", function() {
	  if (currentPage > 1) loadReactivate(currentPage - 1);
	});

	$("#btn-next").on("click", function() {
	  loadReactivate(currentPage + 1);
	});
