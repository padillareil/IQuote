    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="mb-2">
          ...
          <input type="hidden" id="usr-branch-code">
        </div>
      </div>
...
<script>
  ...
  $(document).ready(function () {
      function generateHOCredentials() {
          let fullname   = $("#ho-fullname").val().trim();
          let branchCode = $("#usr-branch-code").val() || "HO";

          if (fullname !== "") {
              let processedName = fullname.toUpperCase().replace(/\s+/g, "");
              $("#ho-username").val(branchCode + "-" + processedName);
              $("#ho-password").val(processedName);
          } else {
              $("#ho-username").val("");
              $("#ho-password").val("");
          }
      ...
      $("#ho-fullname").on("input", generateHOCredentials);
      $("#usr-branch-code").on("input", generateHOCredentials);
