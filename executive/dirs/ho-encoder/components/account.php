<div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
  ...
  <div class="col-md-3 text-md-end text-start">
    <button class="btn btn-outline-secondary" type="button" title="Create Account" onclick="mdlStaffHo()">
...
<hr>
  ...
  $staffStmt = $conn->prepare("
      ...
      FROM USR
      WHERE Createdby = ? AND AccountType = 'Head Office Encoder' AND AccountStatus != 'REMOVED' AND Role = 'HBU'
      ORDER BY Name ASC
  ");
