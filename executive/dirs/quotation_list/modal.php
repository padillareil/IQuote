           ...
           <div class="modal-body p-0"> 
               ...
               <div class="p-4 overflow-auto" style="max-height: 65vh;">
                           ...
                           <table class="table table-borderless align-middle mb-0">
                               ...
                               <tbody>
                                   <tr class="border-bottom">
                                       ...
                                       <td class="ps-3 py-3">
                                           <div class=" text-dark"> MIDEA / FP-53AFC060KENV-Y5 </div>
                                       </td>
                                       <td class="ps-3 py-3">AIRCONDITIONER</td>
                                       <td class="text-end">₱84,990.00</td>
                                       <td class="text-end text-danger">-₱2,000.00</td>
                                       <td class="text-end  pe-3">₱82,990.00</td>
                                   </tr>
                                   <tr class="border-bottom">
                   ...
                   <div class="mb-5">
                           ...
                           <div class="col-md-6">
                               ...
                               <div class="ps-2 border-start border-2">
                                   <ul class="list-unstyled mb-0">
                                       <li class="small text-muted mb-2 d-flex align-items-start">
                                           <span class="me-2 text-muted">•</span>
                                           <h6>Valid for 7 days upon creation. Prices inclusive of VAT.
                                       ...
                                       <li class="small text-muted mb-2 d-flex align-items-start">
                                           <span class="me-2 text-muted">•</span>
                                           <h6>Check payment clearing is required before releasing.</h6>
                                       </li>
                                       <li class="small text-muted mb-2 d-flex align-items-start">
                                           <span class="me-2 text-muted">•</span>
                                           <h6>Quotation is subject to stock availability.</h6>
                                       </li>
                                   </ul>
                               </div>
                           </div>
                           ...
                           <div class="col-md-6">
                               ...
                               <div class="ps-2 border-start border-2">
                                   <ul class="list-unstyled mb-0">
                                       <li class="small text-muted mb-2 d-flex align-items-start">
                                           <span class="me-2 text-muted">•</span>
                                           <h6>1 Year Service Warranty on main unit.</h6>
                                       </li>
                                       <li class="small text-muted mb-2 d-flex align-items-start">
                                           <span class="me-2 text-muted">•</span>
                                           <h6>6 Months Warranty on internal parts.</h6>
                                       </li>
                                       <li class="small text-muted mb-2 d-flex align-items-start">
                                           <span class="me-2 text-muted">•</span>
                                           <h6>Consumables and accessories not included.</h6>
                                       </li>
                                   </ul>
                               </div>
                           </div>
                    ...
                    <h6 class="p-3 bg-warning-subtle border border-warning-subtle rounded-3 small text-dark mb-0">
                        Customer requested afternoon delivery and priority handling.
                    </h6>
