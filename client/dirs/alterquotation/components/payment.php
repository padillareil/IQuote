...
<div class="mb-3 flex-wrap">
	<div class="row">
		<div class="col-md-6">
		  <h4 class="text-muted mb-0">Releasing Store Branch</h4>
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="form-floating mb-4">
			  <select class="form-select" id="mode-payment" name="mode-payment">
		...
		<!-- For installment terms -->
			<div class="form-floating mb-2" id="installment">
			  <select class="form-select" id="installment-period" name="installment-period">
			  	<option selected disabled></option>
			  </select>
			...
			<div class="form-floating mb-2" id="downpayment">
			  <select class="form-select" id="downpayment-select" name="downpayment-select">
			  	<option selected disabled></option>
			  </select>
