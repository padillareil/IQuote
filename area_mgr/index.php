...
<body class="hold-transition sidebar-mini layout-fixed bg-primary-subtle">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="main-menu">
          <ul class="navbar-nav me-auto">
            <li class="nav-item"><a class="nav-link text-white active" href="#" name="menu" menucode="home">Form</a></li>
            ...
            <!-- For Creating Account for branches base on the mother details -->
             <li id="nav-account" class="nav-item"><a class="nav-link text-white" href="#" name="menu" menucode="accounts">Accounts</a></li>
  ...
  <input type="hidden" id="user-region" value="<?php echo $user['Region']; ?>">

  <input type="hidden" id="users-name" value="<?php echo $user['Name']; ?>">
