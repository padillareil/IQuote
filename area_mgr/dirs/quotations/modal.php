  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="mb-2">
          <div class="form-floating mb-2">
            <input type="text" id="very-quote-serial" name="very-quote-serial" class="form-control text-uppercase" placeholder="Reference No" autocomplete="off">
            <label for="very-quote-serial">Reference No</label>
            <small class="text-muted mb-0" id="error-link">Verify Quotation Reference No.</small>
          </div>
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-secondary" onclick="verifyLoadNumber()">Verify</button>
...
<div class="modal fade" id="mdl-quote-status" tabindex="-1" aria-hidden="true">
 ...
 <!-- Toast for Network Error -->
  ...
  <div class="position-fixed top-50 start-50 translate-middle p-3" style="z-index: 1050;">
    <div id="toast-loading-information" class="toast align-items-center border-0 shadow-sm" role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="false">
      <div class="toast-body bg-light border border-danger rounded d-flex align-items-center">
