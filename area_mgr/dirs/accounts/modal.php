    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="mb-2">
          ...
          <input type="hidden" id="staff-userbranch">
          <div class="form-floating mb-2">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="mb-2">
          ...
          <div class="form-floating mb-2">
            <input type="text" id="staff-position" name="staff-position" class="form-control" placeholder="Position" value="Assistant">
            <label for="staff-position">Assistant</label>
          </div>
          <div class="form-floating mb-2">
...
<script>
  ...
  document.getElementById("staff-fullname").addEventListener("input", function () {
    ...
    let branchCode = document.getElementById("branch-code").value;  
    if (fullname !== "") {
