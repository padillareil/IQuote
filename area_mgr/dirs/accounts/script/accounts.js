...
function mdl_UserAccount(UserName){
    ...
    $.post("dirs/accounts/actions/get_userperformance.php",{
        ...
        if(jQuery.trim(response.isSuccess) == "success"){
            ...
            $("#staff-userbranch").val(response.Data.Branch);
...
/*function commitRemove(){
    ...
    var Branch              = $("#staff-userbranch").val();
    var Status              = 'REMOVED';
...
function mdlStaff() {
    ...
    $.post("dirs/accounts/actions/get_branchuser.php", { Region: Region }, function(data) {
...
/* Function to get the bcode of the user */
function loadBranchdode(BranchName) {
    $.post("dirs/accounts/actions/get_branchcode.php", { Branch: BranchName }, function(data) {
        let response = JSON.parse(data);

        if ($.trim(response.isSuccess) === "success") {
            $("#branch-code").val(response.Data.CompanyCode);
        } else {
            alert($.trim(response.Data));
        }
    });
