   ...
   <div class="modal-dialog modal-sm modal-dialog-centered">
     <div class="modal-content">
       ...
       <div class="modal-footer justify-content-center">
         <button type="button" class="btn btn-outline-secondary me-2" id="btn-submit-approved" onclick="commitApproved()">
          <span id="btn-text-approved">Commit</span>
          <span id="btn-spinner-approved" class="spinner-border spinner-border-sm" role="status" aria-hidden="true" style="display:none;"></span>
         </button>
         <button type="button" class="btn btn-outline-danger" id="btn-cancel-approved" data-bs-dismiss="modal">Cancel</button>
       </div>
     </div>
   </div>
 </div>
...
<div class="modal fade" id="mdl-reject-permission" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-sm modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-center">
        <button type="button" class="btn btn-outline-secondary me-2" onclick="commitreject()">
          Reject
        </button>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-secondary" id="btn-submit-reject" onclick="commitReject()">
        <span id="btn-text-reject">Commit</span>
        <span id="btn-spinner-reject" class="spinner-border spinner-border-sm" role="status" aria-hidden="true" style="display:none;"></span>
      </button>
        <button type="button" class="btn btn-outline-danger" id="btn-cancel-reject" data-bs-dismiss="modal">Cancel</button>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="modal-content">
      <div class="modal-body">
        <div  class="form-floating mb-3">
          ...
          <label for="onhold-reason">Reason for On Hold</label>
        </div>
<!--         <small class="text-muted">Additional Remarks(Optional)</small> -->
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-secondary" id="btn-submit-onhold" onclick="commitOnhold()">
          <span id="btn-text-onhold">Commit</span>
          <span id="btn-spinner-onhold" class="spinner-border spinner-border-sm" role="status" aria-hidden="true" style="display:none;"></span>
        </button>
        <button type="button" class="btn btn-outline-danger" id="btn-cance-onhold" data-bs-dismiss="modal">Cancel</button>
      </div>
    </div>
  </div>
</div>
