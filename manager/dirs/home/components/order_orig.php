		...
		<div class="row">
			<div class="col-md-6 mb-2">
				<div class="form-floating mb-2">
				  <input type="text" id="deliverycharge" name="deliverycharge" class="form-control border border-warning-subtle" placeholder="Delivery Charge" value="0">
...
/*	$(document).ready(function () {
	    ...
	    // If delivery charge changes (single field with ID)
	    $(document).on("input", "#deliverycharge", function () {
	        calculateGrandTotal();
	    });
...
*/
	    ...
	    /*function calculateGrandTotal() {
	        ...
	        $(".order-form").each(function () {
	            ...
	            // format the grosstotal input itself with 2 decimals
	            if (rowGross > 0) {
	                $grossInput.val(
...
/*	function loadAddOrder() {
	  ...
	  wrapper.innerHTML = `
		    ...
		    <div class="col-md-6 mb-2">
		      <div class="form-floating mb-2">
		        <select class="form-select brand border border-warning-subtle" name="brand[]">
		    ...
		    <div class="col-md-6 mb-2">
		      <div class="form-floating mb-2">
		        <select class="form-select model border border-warning-subtle" name="model[]">
		          <option selected disabled></option>
		        </select>
		    ...
		    <div class="col-md-6 mb-2">
		      <div class="form-floating mb-2">
		        <input type="text" name="sellingprice[]" class="form-control sellingprice border border-warning-subtle" placeholder="SRP/ Unit Price">
	  	 ...
	  	 <input type="hidden" class="price-limit-total" name="price-limit-total[]">
		    ...
		    <div class="col-md-6 mb-2">
		      <div class="form-floating mb-2">
		        <input type="text" name="quantity[]" class="form-control quantity border border-warning-subtle" placeholder="Quantity">
		    ...
		    <div class="col-md-6 mb-2">
		      <div class="form-floating mb-2">
		        <input type="text" name="discountperunit[]" class="form-control discountperunit border border-warning-subtle" placeholder="Discount Per Unit">
		    ...
		    <div class="col-md-6 mb-2">
		      <div class="form-floating mb-2">
		        <input type="text" name="manualdiscount[]" class="form-control manualdiscount border border-warning-subtle" placeholder="Manual Discount">
		    ...
		    <div class="justify-content-end d-flex">
		      ...
		      <button class="btn btn-outline-danger" type="button" title="Cancel Item Order" onclick="this.closest('.order-form').remove()">Remove</button>
		    </div>
	  `;
	...
	function loadAddOrder() {
	    ...
	    wrapper.innerHTML = `
	        ...
	        <div class="col-md-6 mb-2">
	            <div class="form-floating mb-2">
	                <input type="text" name="quantity[]" class="form-control quantity border-warning-subtle" placeholder="Quantity">
	                <label>Quantity</label>
	            </div>
	        </div>
	        <!-- Discount per unit -->
	        <div class="col-md-6 mb-2">
	            <div class="form-floating mb-2">
	                <input type="text" name="discountperunit[]" class="form-control discountperunit border-warning-subtle" placeholder="Discount Per Unit">
	                <label>Discount Per Unit</label>
	            </div>
	        </div>
	        <!-- Discounted Amount per unit -->
	  ...
	  $.post("dirs/home/actions/get_price.php", { 
	    ...
	    if ($.trim(response.isSuccess) === "success" && response.Data.length > 0) {
	      ...
	      Swal.fire({
	        ...
	        $row.find(".quantity").addClass('disabled');
	      });
	      $row.find(".sellingprice").val('');
	      $row.find(".price-limit").val('');
	    }
	...
	function loadLimitPrice(ItemCode, $row) {
	  ...
	  $.post("dirs/home/actions/get_price.php", { 
	    ...
	    if ($.trim(response.isSuccess) === "success" && response.Data.length > 0) {
	      ...
	      $row.find(".sellingprice").val('');
	      $row.find(".price-limit").val('');
	      // $row.find(".quantity").prop('disabled', true); Temporary disabled
	    }
	  });
	}
...
/*	function applyManualDiscount(btn) {
	...
	function loadForm4() {
	  let isValid = true;
	  let missingFields = [];
	  $(".order-form").each(function (index) {
	    let $row = $(this);
	    let brand       = $row.find(".brand").val();
	    let model       = $row.find(".model").val();
	    let category    = $row.find(".category").val();
