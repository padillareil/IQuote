...
$Status             = $_POST['Status'];
$AccountReason      = $_POST['AccountReason'];
...
try {
    ...
    $Software = 'IQUOTE';
    $Action = 'Disable Access' . $UserName;
    ...
    $upd_status = $conn->prepare("UPDATE usr SET AccountStatus=?, AccountReason, WHERE UserName=?");
    $upd_status->execute([$Status,$AccountReason, $UserName]);
