		...
		<div class="row">
			<div class="col-md-6 mb-2">
				<div class="form-floating mb-2">
				  <input type="text" id="deliverycharge" name="deliverycharge" class="form-control border-warning-subtle" placeholder="Delivery Charge" value="0">
	...
	function loadAddOrder() {
	    ...
	    wrapper.innerHTML = `
	        ...
	        <div class="justify-content-end d-flex">
	            <button class="btn btn-outline-secondary me-2" type="button" title="Apply Manual Discount" onclick="applyManualDiscount(this)">Apply Discounted Amount</button>
	...
	function loadLimitPrice(ItemCode, $row) {
	  ...
	  $.post("dirs/home/actions/get_price.php", { 
	    ...
	    if ($.trim(response.isSuccess) === "success" && response.Data.length > 0) {
	      ...
	      $row.find(".sellingprice").val('');
	      $row.find(".price-limit").val('');
	      // $row.find(".quantity").prop('disabled', true); Temporaily disable for now then change if OPCIS was completely correct pricing
	    }
	  });
	}
