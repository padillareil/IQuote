<div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
  ...
  <!-- <div class="col-md-3">
    <select class="form-select border-warning-subtle" id="prev-customers" name="prev-customers">
...
<div class="row mt-4">
	<div class="col-md-6 mb-2">
		<div class="form-floating mb-2">
		  <input type="text" id="customer-name" name="customer-name" class="form-control border-warning-subtle" placeholder="Customer" autocomplete="off">
	...
	<div class="col-md-6 mb-2">
		<div class="form-floating mb-2">
		  <input type="text" id="contactnumber" name="contactnumber" class="form-control border-warning-subtle" placeholder="Contact number" autocomplete="off" maxlength="11">
	...
	<div class="col-md-6 mb-2">
		<div class="form-floating mb-2">
		  <select class="form-select border-warning-subtle" id="customertype" name="customertype">
		  	<option selected disabled></option>
	...
	<div class="col-md-6 mb-2">
		<div class="form-floating mb-2">
		  <input type="text" id="tinumber" name="tinumber" class="form-control border-warning-subtle" placeholder="TIN Number" autocomplete="off">
	...
	<div class="col-md-12 mb-2 d-none" id="customer-company">
		<div class="form-floating mb-2">
		  <input type="text" id="companyname" name="companyname" class="form-control border-warning-subtle" placeholder="Company" autocomplete="off">
	...
	<div class="col-md-6 mb-2">
		<div class="form-floating mb-2">
		  <select class="form-select border-warning-subtle" id="province" name="province">
		  	<option selected disabled></option>
		  </select>
	...
	<div class="col-md-6 mb-2">
		<div class="form-floating mb-2">
		  <select class="form-select border-warning-subtle" id="municipality" name="municipality">
		  	<option selected disabled></option>
		  </select>
	...
	<div class="col-md-6 mb-2">
		<div class="form-floating mb-2">
		  <select class="form-select border-warning-subtle" id="barangay" name="barangay">
		  	<option selected disabled></option>
		  </select>
	...
	<div class="col-md-6 mb-2">
		<div class="form-floating mb-2">
		  <input type="text" id="street" name="street" class="form-control border-warning-subtle" placeholder="Street/ Bldg No." autocomplete="off">
	...
	<div class="col-md-6 mb-2">
		<div class="form-floating mb-2">
		  <input type="text" id="zipcode" name="zipcode" class="form-control border-warning-subtle" maxlength="4" placeholder="Zipcode" autocomplete="off">
	...
	<div class="col-md-6 mb-2">
		<div class="form-floating mb-2">
		  <input type="text" id="landmark" name="landmark" class="form-control border-warning-subtle" placeholder="Landmark (Optional)" autocomplete="off">
