...
// Fetch user info
$Admindtls = $conn->prepare("SELECT Signature, Name, Bcode, Branch, Corporation, UPosition, UserName, Region, Email, Mobile FROM USR WHERE UserName = ?");
...
$Landline = ''; /*Temporarily empty since it focus on mobile contacts*/
