		...
		<div class="row">
			<div class="col-md-6 mb-2">
				<div class="form-floating mb-2">
				  <input type="text" id="edit-deliverycharge" name="edit-deliverycharge" class="form-control border border-warning" placeholder="Delivery Charge">
				  <label for="edit-deliverycharge">Delivery Charge</label>
				</div>
			</div>
			<div class="col-md-6 mb-2">
				<div class="form-floating mb-2">
				  <input type="text" id="edit-grandtotal" name="edit-grandtotal" class="form-control" placeholder="Grand Total" readonly>
