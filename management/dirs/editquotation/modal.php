...
<!-- Modal Generate Link-->
 ...
 <!-- Modal reject prompt -->
 <div class="modal fade" id="mdl-cancel-dialog" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered">
     <div class="modal-content">
       <div class="modal-body">
         <small class="text-muted">Please specify the reason for your decision to cancel this quotation.</small>
         <div  class="form-floating mb-3">
           <select class="form-select" id="cancel-reason">
             <option disabled selected></option>
             <option value="Changed of Mind">Changed of Mind</option>
             <option value="Change in Requirements">Change in Requirements</option>
             ...
             <option value="Product/Service Availability">Product/Service Availability</option>
           </select>
           <label for="cancel-reason">Reason for On Process</label>
         </div>
         <div class="form-floating mb-3">
           <textarea class="form-control" id="cancel-comment" name="cancel-comment" placeholder="Remarks" style="height: 20vh;" maxlength="30"></textarea>
           <label for="cancel-comment">Remarks</label>
         </div>
         <small class="text-muted">Maximum of 30 characters.</small>
       </div>
       <div class="modal-footer">
         <button type="button" class="btn btn-outline-secondary" onclick="commitCancel()">Commit</button>
         <button type="button" class="btn btn-outline-danger" data-bs-dismiss="modal">Cancel</button>
       </div>
     </div>
   </div>
