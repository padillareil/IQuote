...
<div class="d-flex justify-content-end align-items-center mb-3 flex-wrap">
  ...
  <div class="col-md-3 text-md-end text-start"> -->
    <!-- Verify Button -->
    <button class="btn btn-outline-secondary" type="button" title="Verify Quotation" onclick="loadmdlVerify()">
          ...
          $list.append(`
              <a href="#" class="list-group-item list-group-item-action">
                  ...
                  <div class="mt-3 d-flex justify-content-end gap-2">
                      ...
                      <button 
                          class="btn btn-sm btn-outline-secondary ${ (item.Status === 'ON HOLD' || item.Status === 'REJECTED' || item.Status === 'CANCELLED') ? '' : 'd-none' }" 
