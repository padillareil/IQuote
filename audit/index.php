...
try {
  ...
  /*Check User multiple role*/
   if (!$user || !in_array($user['Role'], ['Audit'])) {
       session_destroy();
       header("Location: ../login.php");
       exit();
   }
...
<body class="hold-transition sidebar-mini layout-fixed bg-secondary-subtle">
  <div class="wrapper d-flex flex-column min-vh-100">
    <nav class="navbar navbar-expand-lg py-2"  
         style="background-color: #C0C0C0; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="main-menu">
          <ul class="navbar-nav me-auto">
            <li class="nav-item"><a class="nav-link active" href="#" name="menu" menucode="home">Home</a></li>
            <li class="nav-item"><a class="nav-link" href="#" name="menu" menucode="findings">Findings</a></li>
            <li class="nav-item"><a class="nav-link" href="#" name="menu" menucode="settings">Settings</a></li>
          </ul>
          <div class="d-flex align-items-center">
            <a href="#" class="text-danger text-decoration-none" onclick="clientLogout()">
