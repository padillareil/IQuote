<div class="container">
	<div class="card shadow-sm">
		<div class="card-header">
			<h4 class="card-title ml-2">Quotations Findings</h4>
...
<!-- <script>
	...
	function loadQuotations(page = 1) {
	  ...
	  $.post("dirs/findings/actions/get_quotations.php", {
	  ...
	  pageData.forEach(item => {
	    $list.append(`
	      <tr class='text-center'>
	        ...
	        <td>${item.CSTMER}</td>
	        <td>
	          <button class="btn btn-success btn-sm" type="button" onclick="mdlAttachment('${item.QNumber}')">
	            Attachment
	          </button>
	        </td>
	        <td>
	          <button class="btn btn-outline-secondary btn-sm" type="button" onclick="mdlFindings('${item.QNumber}')">
	            Add Findings
	          </button>
	        </td>
	      </tr>
