<?php
	...
	try{
		...
		$ins_branchbank = $conn->prepare("INSERT INTO bnk
			(Branch, Bank, AccName, AccNumber, Corpo, BnkOwnership, Corpcode)VALUES(?,?,?,?,?,?,?)");
		$ins_branchbank->execute([$Branch, $Bank, $AccountName, $AccountNumber, $Corporation, $Bankownership, $Corpcode]);
