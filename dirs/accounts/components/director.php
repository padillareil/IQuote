...
<div class="d-flex justify-content-between align-items-center mb-3">
    <button class="btn btn-outline-secondary mb-3" type="button" onclick="createDirector()">Create Director</button>
    <div class="d-flex align-items-center gap-2">
        <input type="search" name="search-director" id="search-director" class="form-control" placeholder="Search" style="max-width: 250px;">
    </div>
</div>
  ...
  <div class="card-body">
    <div class="table-responsive overscroll-auto" style="height: 60vh;">
      <table class="table table-bordered">
        ...
        <tbody class="text-center" id="director-table">
          <?php if (count($rows) > 0): ?>
...
<script>
  $(document).ready(function(){
      $("#search-director").on("keyup", function(){
          ...
          $("#director-table tr").filter(function() {
