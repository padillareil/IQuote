...
<div class="d-flex justify-content-end">
    <input type="search" name="search-online" id="search-online" class="form-control" placeholder="Search" style="max-width: 250px;">
</div>
  ...
  <div class="card-body">
    <div class="table-responsive overscroll-auto" style="height: 60vh;">
      <table class="table table-bordered">
        ...
        <tbody class="text-center" id="online-table">
          <?php if (count($rows) > 0): ?>
...
<script>
  $(document).ready(function(){
        $("#search-online").on("keyup", function(){
            var value = $(this).val().toLowerCase();
            $("#online-table tr").filter(function() {
