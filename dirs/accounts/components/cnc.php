...
<div class="d-flex justify-content-end">
    <input type="search" name="search-cnc" id="search-cnc" class="form-control" placeholder="Search" style="max-width: 250px;">
</div>
<div class="card shadow-sm mt-2">
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-bordered overscroll-auto" style="height: 60vh;">
        ...
        <tbody class="text-center" id="cnc-table">
          <?php if (count($rows) > 0): ?>
...
$(document).ready(function(){
  $("#search-cnc").on("keyup", function(){
      var value = $(this).val().toLowerCase();
      $("#cnc-table tr").filter(function() {
