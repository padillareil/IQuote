...
<div class="d-flex justify-content-between align-items-center mb-3">
    <button class="btn btn-outline-secondary" type="button" onclick="mdl_createho()">Create Account</button>
    <div class="d-flex align-items-center gap-2">
        <input type="search" name="search-ho" id="search-ho" class="form-control" placeholder="Search" style="max-width: 250px;">
    </div>
</div>
  ...
  <div class="card-body">
    <div class="table-responsive overscroll-auto" style="height: 60vh;">
      <table class="table table-bordered">
        ...
        <tbody class="text-center" id="ho-table">
          <?php if (count($rows) > 0): ?>
...
<script>
  $(document).ready(function(){
      $("#search-ho").on("keyup", function(){
          var value = $(this).val().toLowerCase();
          $("#ho-table tr").filter(function() {
